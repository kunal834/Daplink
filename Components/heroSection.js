          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left z-10 lg:order-1 order-1">
            ...
            <Reveal delayClass="stagger-4" className="w-full max-w-md mx-auto lg:mx-0 relative group">
              ...
              >
                ...
                <button className={`shimmer-btn h-full px-4 sm:px-6 rounded-lg font-bold text-xs sm:text-sm whitespace-nowrap active:scale-95 flex items-center justify-center ${theme === 'dark' ? 'bg-white text-black' : 'bg-black text-white'}`}>
                  Claim Link
                </button>
              </div>
