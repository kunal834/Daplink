      ...
      <div className="z-10 w-full max-w-md px-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 p-8">
          ...
          <form className="space-y-4">
            ...
            <button className="w-full bg-slate-950 text-white rounded-lg py-2.5 text-sm font-medium hover:bg-slate-800 transition-colors shadow-lg shadow-slate-900/20">
              Sign In
            </button>
          </form>
